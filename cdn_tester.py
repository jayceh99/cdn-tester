...
def main():
    ...
    #r = requests.get('https://media.video.cloud.edu.tw/vod/_definst_/mp4:uploads.video/2023/04/video_401468_1440.mp4/chunk_ctaudio_ridp0aa0br127435_cs3175421_mpd.m4s')
